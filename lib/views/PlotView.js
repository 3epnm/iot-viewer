var PlotView = (function () {
	...
	var updateLegendX = function (datetime) {
		if ($('.legendX', $(selector)).length == 0) {
			$(selector).append('<div class="legendX legend"><div style="position: absolute; height: 24px; bottom: 30px; right: 13px; background-color: rgb(255, 255, 255); opacity: 0.85;"></div><table style="position: absolute; bottom: 30px; right: 13px; font-size:smaller; color: #545454"><tbody><tr><td class="legendLabel">Datetime</td><td class="datetime"></td></tr></tbody></table></div>');
		}
	...
	var init_plot = function () {
		instance_plot = $.plot(selector, get_plotdata(), getOptions());
